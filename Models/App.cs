...
namespace LogHunter
{
    public class App
    {
        ...
        public static App IamDataSyncService { get => new("IamDataSyncService"); }
        public static readonly App[] AllApps = [Plutus, ChromeRiverService, CobblestoneService, IamDataSyncService];
