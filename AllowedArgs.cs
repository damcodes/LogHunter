...
namespace LogHunter
{
    public class AllowedArgs
    {
        ...
        public static readonly string[] FullArgs = [Level.Full, CallSite.Full, Start.Full, End.Full, Message.Full, TransactionId.Full, UserId.Full, Help.Full];
        public static readonly string[] FlagArgs = [Level.Flag, CallSite.Flag, Start.Flag, End.Flag, Message.Flag, TransactionId.Flag, UserId.Flag, Help.Flag];
        public static readonly AllowedArgs[] AllArgs = [Level, CallSite, Start, End, Message, TransactionId, UserId, Help];
    }
}